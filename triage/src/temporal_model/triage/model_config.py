...
Mirrors ``eval/src/temporal_model/eval/model_config.py``: merges manifest.yaml
(detector provenance), config.yaml (decision/infer/model_input/tubes/classifier),
and logistic_calibrator.json. Tolerant: a missing or unreadable zip returns {}
(e.g. test runs that stub model loading); a missing member is omitted or None.
"""
